...
import com.urlShortner.shortner.repository.ClickEventRepository;
import com.urlShortner.shortner.repository.UrlMappingRepository;
...
public class UrlMappingService {
    ...
    public List<ClickEventDTO> getClickEventsByDate(String shortUrl, LocalDateTime start, LocalDateTime end) {
        UrlMapping urlMapping = urlMappingRepository.findByShortUrl(shortUrl).orElseThrow(()->new RuntimeException("shrtUrl not found"));
        if (urlMapping != null) {
